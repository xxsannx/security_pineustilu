...
<div id="cancelModal" class="fixed inset-0 backdrop-blur-sm bg-black/20 z-[9999] items-center justify-center p-4 hidden"
    ...
    <div class="bg-white rounded-3xl max-w-md w-full overflow-hidden shadow-2xl border-2 border-gray-100 transform transition-all">
        <!-- Modal Header -->
        <div class="bg-gradient-to-br from-gray-50 to-white border-b-2 border-gray-100 p-6">
            <div class="flex items-center gap-3 mb-2">
                ...
                <h3 id="cancelModalTitle" class="text-xl font-bold text-gray-800" style="font-family: 'Bizon', sans-serif;">
                    Batalkan Pesanan?
                </h3>
            </div>
