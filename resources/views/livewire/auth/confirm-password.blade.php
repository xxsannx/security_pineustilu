            ...
            <div
                ...
                <div class="text-center space-y-3 sm:space-y-4 pt-10 sm:pt-12">
                    ...
                    <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-[#017249]"
                        style="font-family: 'Bizon', sans-serif;">{{ __('Confirm Password') }}</h1>
                    <p class="text-gray-600 text-sm sm:text-base">{{ __('This is a secure area of the application. Please confirm your password before continuing.') }}</p>
                </div>
